...
public class DialogueController : MonoBehaviour
{
    ...
    void __init_dialogue()
    {
        ...
        dialogues.Add(new Dialogue("How does my tie look?", "It looks like a two year old child tied it.", "It looks good, but I can fix up the knot if you'd like.", "It looks great sir.", 3));
        dialogues.Add(new Dialogue("I want to turn the White House grounds into a private golf course that only I can use.", "Great idea sir, you can work on policy while you golf.", "Fun idea, you could track points for how many tourists you hit with a golf ball.", "I wouldn't recommend it.", 1));
        dialogues.Add(new Dialogue("I NEED a pumpkin spice latte NOW.", "But they're out of season...", "I'll get it for you as fast as possible!", "No problem let me pull up Starbucks CEO on speed dial and get that ordered for you...", 2));
        dialogues.Add(new Dialogue("I'm going to have Secret Service teach me how to handle a gun.", "I don't think that's necessary but it's your call.", "That seems like a waste of their time… just let them do their job.", "Excellent idea, then you can protect yourself.", 3));
        dialogues.Add(new Dialogue("Isn't my wife beautiful? She's the best!", "How much do you pay her monthly to be your wife?", "She's gorgeous, your a lucky man.", "Good catch sir.", 2));
        dialogues.Add(new Dialogue("Maybe China will give us a small loan to build the wall... ", "Of course they would be willing to help, excellent idea.", "We already owe them an insane amount of debt...", "It's probably not a good idea to go more into debt with China.", 1));
        dialogues.Add(new Dialogue("Look at this picture I painted! Isn't it fantastic?", "It's pretty good, but you should focus on your work.", "I thought that was a gift from a toddler...", "It should be in an art gallery! Beautiful!", 3));
        dialogues.Add(new Dialogue("I really want to hit this nuke button...", "*Softly* Don't...", "I know hitting buttons is fun but you must resist!", "No big deal Mr. President, you'll just start start world war 3.", 2));
        dialogues.Add(new Dialogue("I really hate going to the doctor, do I have to?", "You must Mr. President, we need you!", "Don't go, maybe if we're lucky you won't make it to next election.", "You probably should, you're pretty old and need to remain healthy.", 1));
        dialogues.Add(new Dialogue("Man I LOVE this Hawaiian shirt!", "That is a terrible shirt, burn it!", "You might want to maintain a more professional look at work.", "It looks great on you sir!", 3));
        dialogues.Add(new Dialogue("*Hiss* *Hiss* *Hissss*", "Uh… are you ok?", "Excellent snake impression sir.", "The President is a lizard person in disguise, RUN!", 2));
        dialogues.Add(new Dialogue("I want some ice cream. Could you get me a drumstick?", "Of course sir, caramel or chocolate?", "You might want to watch your health sir.", "Too bad, I already ate them all.", 1));
    }
